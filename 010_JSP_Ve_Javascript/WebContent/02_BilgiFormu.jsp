...
<body>
	...
	<h3>
		<font face=verdana color=green> <b>Bilgi Formu</b></font>
	</h3>

	<form name="bilgiFormu" method="post" action="02_BilgiFormunuKontrolEt.jsp">
		...
		<table border="5" id="bilgiTablosu">
			<%
				...
				if (eksikAlanlariAlGoster != null && eksikAlanlariAlGoster.trim().length() > 0) {
					out.println("<tr><td colspan='2'>" + "<h3><font face=verdana color=red>" + eksikAlanlariAlGoster
							+ "</font></h3></td></tr>");
				}
			%>
			...
			</tr> <!-- if(request.getParameter("adi") != null) bunu yap request.getParameter("adi") degilse bunu yap ""-->
			...
			<tr>
				...
				<td><input type="text" name="sehir" size="20"
					value="<%=request.getParameter("sehir") != null ? request.getParameter("sehir") : ""%>"></td>
			</tr>

		</table>

		<p>
			<input type="submit" value="Gönder" name="Gönder"> <input
				type="reset" value="Temizle" name="Temizle">
		</p>
