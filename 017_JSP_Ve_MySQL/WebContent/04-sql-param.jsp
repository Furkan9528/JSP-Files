...
<body>
	...
	<table border="1" width="100%">
            ...
            <tr>
                ...
                <td><c:out value="${satir.personelsposta}"/></td>
	...
	<c:set var="parametrePersonelid" value="6"/> <!-- 6. kaydı sil -->
	<hr>
	
	
	
	<sql:update dataSource="${veriKaynagi}" var="guncelle_silme_ekleme">
	  DELETE FROM companydb.personel 
	  WHERE personelid = ?  
	  <sql:param value="${parametrePersonelid}" /> 
	  </sql:update><!-- Bu da bize yukarıdaki 6 değerini koyuyor. Dışardan aldığımız değerde olabilir bu nedenle yazdık.  -->
