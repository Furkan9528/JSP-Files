...
<body>
    ...
    <br>
    fmt:parseDate ile işlenen Tarihimiz : <font color="red"><c:out value="${parsedDateEdilmisTarih}" /></font>
    ...
    <br>
    fmt:setTimeZone ile Saat dilimimizi değiştirerek  yapalım :<fmt:setTimeZone value="GMT-23" />
