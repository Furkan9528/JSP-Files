...
<body>
	...
	<br>
	<font color="blue">Mesajdaki 3. karakter ile 33. karaktere kadar
		olan kısmı yaz.</font>
	<c:out value="${fn:substring(cumlemiz,3,33)}" />
	<br>
	<font color="blue">Mesajdaki "hayatından" kelimesinden sonraki
		sözcükleri yaz.</font>
	<c:out value="${fn:substringAfter(cumlemiz,'hayatından')}" />
	<br>
	<font color="blue">Mesajdaki "hayatından" kelimesinden önceki
		sözcükleri yaz.</font>
	...
	<c:out value="${fn:containsIgnoreCase(cumlemiz,'M')}" />
	<br>
