    ...
    <body>
        ...
        <table border="1" width="500">
            ...
            <tbody>
                ...
                <tr>
                    <td>Örnek 3:</td>
                    <td><a href="ornek3.jsp?gecerlilikdenetimi=true&adisoyadi=FaridaAsadova&puani=10">
                 ...
                 <tr>
                    ...
                    <td>
                        <c:url value="ornek4.jsp" var="gonderilecekParametreler">
                            <c:param name="adi" value="Veysel Karani" />
                ...
                <tr>
                    ...
                    <td>
                        <c:url value="ornek5.jsp" var="gonderilecekParametreler">
                        	<c:param name="for_each_icin_parametre_adi" value="Orhan,Eripek, Mimar Aslan" />
                       		<c:param name="for_token_icin_parametre_adi" value="Orhan,Eripek -  babacan   - adam gibi adam" />
                        </c:url>
